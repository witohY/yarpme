...
*/
// int  限定符  未定义行为  数组种类  数据类型  IR节点的种类  一元表达式操作符
// 二进制操作符  调用lib库种类  Loopendkind???  选项  语言种类  数组大小
// 突变  检查算法  特殊的常数  操作符  const的使用
//////////////////////////////////////////////////////////////////////////////
...
enum class PragmaKind {
    CLANG_VECTORIZE,   //向量化
    CLANG_INTERLEAVE,  //交错技术
    CLANG_VEC_PREDICATE,//向量谓词指令
    CLANG_UNROLL,   //循环展开
    OMP_SIMD,
    MAX_PRAGMA_KIND,
};
